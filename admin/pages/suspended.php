...
<nav>
    ...
    <div>
        <a class="yellow active" href="suspended.php">In sospeso</a>
        ...
        <li id="<?php echo 'ID-' . $row['id'] ?>" style="margin: 15px; width: 300px;" class="list-group-item">
            ...
            <div class="group-form">
                <button class="btn btn-success" data-container="<?php echo 'ID-' . $row['id']; ?>" data-matricola="<?php echo $row['matricola']; ?>">
                    <a href="../requests/accept/_suspend.php?input=<?php echo $row['matricola']; ?>&action=accept">
                        Accetta
                    </a>
                </button>
                <button class="btn btn-danger" data-container="<?php echo 'ID-' . $row['id']; ?>" data-matricola="<?php echo $row['matricola']; ?>">
                    <a href="../requests/deny/_suspend.php?input=<?php echo $row['matricola']; ?>&action=deny">
                        Rifiuta
                    </a>
                </button>
            </div>
