<?php
    ...
    $result = $conn->query("SELECT * FROM BebRifiutate");
?>

<html>
    <head>
        <title> RIFIUTATE | B&amp;B </title>
    ...
    <body>
        <nav>
            ...
            <div>
                ...
                <a class="red active" href="denies.php">Rifiutate</a>
            </div>
                ...
                <li id="<?php echo 'ID-' . $row['id'] ?>" style="margin: 15px; width: 300px;" class="list-group-item">
                    ...
                    <div class="group-form">
                        <button class="btn btn-success" data-container="<?php echo 'ID-' . $row['id']; ?>" data-matricola="<?php echo $row['matricola']; ?>">
                            <a href="../requests/accept/_deny.php?input=<?php echo $row['matricola']; ?>&action=accept">
                                Accetta
                            </a>
                        </button>
                        <button class="btn btn-warning" data-container="<?php echo 'ID-' . $row['id']; ?>" data-matricola="<?php echo $row['matricola']; ?>">
                            <a href="../requests/suspend/_deny.php?input=<?php echo $row['matricola']; ?>&action=deny">
                                Sospendi
                            </a>
                        </button>
                    </div>
